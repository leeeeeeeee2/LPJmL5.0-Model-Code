...
extern Harvest harvest_grass_mowing(Stand *stand);
extern Harvest harvest_grass_grazing_ext(Stand *stand);
extern Harvest harvest_grass_grazing_ext_livestock(Stand *stand);
extern Harvest harvest_grass_grazing_int(Stand *stand);
