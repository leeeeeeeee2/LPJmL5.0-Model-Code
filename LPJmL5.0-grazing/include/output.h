...
typedef struct
{
  ...
  Real anmineralization_mgrass;
  Real animmobilization_mgrass;
  Real anuptake_agr;
  Real anuptake_mgrass;
  Real anleaching_agr;
  Real an2o_denit_agr;
  Real an2o_nit_agr;
  Real anh3_agr;
  Real an2_agr;
  Real alitfalln_agr;
  Real alitfalln_mgrass;
  Real aharvestn_agr;
  Real aharvestn_mgrass;
  Real aseedn_agr;
  Real aseedn_mgrass;
  Real adelta_norg_soil_agr;
  Real adelta_nmin_soil_agr;
  Real adelta_nveg_soil_agr;
  Real adelta_norg_soil_mgrass;
  Real adelta_nmin_soil_mgrass;
  Real adelta_nveg_soil_mgrass;
  Real cellfrac_agr;
  ...
  Real mgrass_n2o_denit;      /**< annual N2O emissions from denitrification on managed grassland stands (gN/m2/yr) */
  Real mgrass_n2o_nit;        /**< annual N2O emissions from nitrification on managed grassland stands (gN/m2/yr) */
  Real mgrass_n2_emis;        /**< annual N2 emissions on managed grassland stands (gN/m2/yr) */
  Real mgrass_leaching;       /**< annual NO3 leaching on managed grassland stands (gN/m2/yr) */
  Real mgrass_bnf;            /**< annual biological N fixation on managed grassland stands (gN/m2/yr) */
  Real mgrass_volatilization; /**< annual NH3 volatilization from managed grassland stands (gN/m2/yr) */
  Real yieldc_mgrass;         /**< annual milk yield C from managed grassland (gC/m2/yr) */
  Real yieldn_mgrass;         /**< annual milk yield N from managed grassland (gN/m2/yr) */
  Real uptakec_mgrass;        /**< annual uptake C from managed grassland (gC/m2/yr) */
  Real uptaken_mgrass;        /**< annual uptake N from managed grassland (gN/m2/yr) */
  Real deficit_lsu_mp;        /**< annual maximim MP deficit per LSU on managed grassland (kgN) */
  Real deficit_lsu_ne;        /**< annual maximum NE deficit per LSU on managed grassland (Mcal) */
  Real manurec_mgrass;        /**< annual manure C from managed grassland (gC/m2/yr) */
  Real manuren_mgrass;        /**< annual manure N from managed grassland (gN/m2/yr) */
  Real urinec_mgrass;         /**< annual urine C from managed grassland (gC/m2/yr) */
  Real urinen_mgrass;         /**< annual urine N from managed grassland (gN/m2/yr) */
  Real respc_mgrass;          /**< annual animal respiration C from managed grassland (gC/m2/yr) */
  Real methanec_mgrass;       /**< annual animal methane C from managed grassland (gC/m2/yr) */
  Real mgrass_gpp;
  Real mgrass_ra;
  Real mgrass_rh;
  Real mgrass_deltac;
