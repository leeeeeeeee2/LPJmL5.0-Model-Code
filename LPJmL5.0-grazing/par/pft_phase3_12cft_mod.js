...
[
  /* first pft */
  {
    ...
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : 2.0, "high" : 55.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
...
/* 3. pft */
  {
    ...
    "phenology" : EVERGREEN,/* phenology */
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : -4.0, "high" : 42.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
...
/* 5. pft */
  {
    ...
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : -4.0, "high" : 38.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
...
/* 9. pft */
  {
    ...
    "path" : C4,            /* pathway */
    "temp_co2" : { "low" : 6.0, "high" : 55.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
...
/* 10. pft */
  {
    ...
    "phenology" : ANY,      /* phenology */
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : -4.0, "high" : 45.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
...
/* 3. bft ONLY FOR BIOENERGY*/
  {
    ...
    "phenology" : ANY,      /* phenology */
    "path" : C4,            /* pathway */
    "temp_co2" : { "low" : 4.0, "high" : 55.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
...
/* 1. cft */
  {
    ...
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : 0.0, "high" : 30.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    ...
    "hlimit" : 365,         /* hlimit: max. growing season length (days) after which harvest is triggered, GGCMI Phase 3 max. value plus 15% to allow for annual variation */
...
/* 2. cft */
  {
    ...
    "phenology" : CROPGREEN,/* phenology */
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : 6.0, "high" : 40.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    "temp_photos" : { "low" : 22., "high" : 27. }, /* lower and upper limit of temperature optimum for photosynthesis (deg C) 25 26*/
    "temp" : { "low" : -1000.0, "high" : 1000 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.40428,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : ALPHA_FUELP_TROP, /* scaling factor fire danger index */
    "fuelbulkdensity" : 2.0, /* fuel bulk density */
    ...
    "hlimit" : 288,         /* hlimit: max. growing season length (days) after which harvest is triggered, GGCMI Phase 3 max. value plus 15% to allow for annual variation */
    "fallow_days" : 30,     /* fallow_days: wait after harvest until next sowing */
...
/* 3. cft */
  {
    ...
    "phenology" : CROPGREEN,/* phenology */
    "path" : C4,            /* pathway */
    "temp_co2" : { "low" : 8.0, "high" : 42.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    ...
    "hlimit" : 334,         /* hlimit: max. growing season length (days) after which harvest is triggered, GGCMI Phase 3 max. value plus 15% to allow for annual variation */
    "fallow_days" : 30,     /* fallow_days: wait after harvest until next sowing */
...
/* 4. cft */
  {
    ...
    "phenology" : CROPGREEN,/* phenology */
    "path" : C4,            /* pathway */
    "temp_co2" : { "low" : 6.0, "high" : 45.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    "temp_photos" : { "low" : 23.5, "high" : 28.5 }, /* lower and upper limit of temperature optimum for photosynthesis (deg C) 25 26*/
    "temp" : { "low" : -1000.0, "high" : 1000 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.40428,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : ALPHA_FUELP_TROP, /* scaling factor fire danger index */
    "fuelbulkdensity" : 2.0, /* fuel bulk density */
    ...
    "hlimit" : 299,         /* hlimit: max. growing season length (days) after which harvest is triggered, GGCMI Phase 3 max. value plus 15% to allow for annual variation */
    "fallow_days" : 30,     /* fallow_days: wait after harvest until next sowing */
...
/* 5. cft */
  {
    ...
    "phenology" : CROPGREEN,/* phenology */
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : -4.0, "high" : 40.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    "temp_photos" : { "low" : 24., "high" : 29. }, /* lower and upper limit of temperature optimum for photosynthesis (deg C) 25 26*/
    "temp" : { "low" : -1000.0, "high" : 1000 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.40428,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : ALPHA_FUELP_TROP, /* scaling factor fire danger index */
    "fuelbulkdensity" : 2.0, /* fuel bulk density */
    ...
    "calcmethod_sdate" : TEMP_PREC_CALC_SDATE, /* calc_sdate: method to calculate the sowing date*/
    "sdatenh" : 1, "sdatesh" : 181, /* sdatenh,sdatesh: init sowing date for northern and southern hemisphere (julian day) */
    "hlimit" : 282,         /* hlimit: max. growing season length (days) after which harvest is triggered, GGCMI Phase 3 max. value plus 15% to allow for annual variation */
    "fallow_days" : 30,     /* fallow_days: wait after harvest until next sowing */
...
/* 6. cft */
  {
    ...
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : -4.0, "high" : 40.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    "temp_photos" : { "low" : 15., "high" : 20. }, /* lower and upper limit of temperature optimum for photosynthesis (deg C) 25 26*/
    "temp" : { "low" : -1000.0, "high" : 1000 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.40428,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : ALPHA_FUELP_TROP, /* scaling factor fire danger index */
    "fuelbulkdensity" : 2.0, /* fuel bulk density */
...
/* 8. cft */
  {
    ...
    "phenology" : CROPGREEN,/* phenology */
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : 8.0, "high" : 40.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    "temp_photos" : { "low" : 22., "high" : 27. }, /* lower and upper limit of temperature optimum for photosynthesis (deg C) 25 26*/
    "temp" : { "low" : -1000.0, "high" : 1000 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.40428,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : ALPHA_FUELP_TROP, /* scaling factor fire danger index */
...
/* 9. cft */
  {
    ...
    "phenology" : CROPGREEN,/* phenology */
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : 5.0, "high" : 40.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    "temp_photos" : { "low" : 22., "high" : 27. }, /* lower and upper limit of temperature optimum for photosynthesis (deg C) 25 26*/
    "temp" : { "low" : -1000.0, "high" : 1000 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.40428,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : ALPHA_FUELP_TROP, /* scaling factor fire danger index */
...
/* 11. cft */
  {
    ...
    "phenology" : CROPGREEN,/* phenology */
    "path" : C3,            /* pathway */
    "temp_co2" : { "low" : 0.0, "high" : 40.0 }, /* lower and upper temperature limit for co2 uptake (deg C) 24 27 */
    "temp_photos" : { "low" : 11., "high" : 16. }, /* lower and upper limit of temperature optimum for photosynthesis (deg C) 25 26*/
    "temp" : { "low" : -1000.0, "high" : 1000 }, /* lower and upper coldest monthly mean temperature(deg C) 28 29*/
    "soc_k" : 0.40428,     /* shape factor for soil organic matter vertical distribution*/
    "alpha_fuelp" : ALPHA_FUELP_TROP, /* scaling factor fire danger index */
    "fuelbulkdensity" : 2.0, /* fuel bulk density */
...
/* 12. cft */
  {
    ...
    "phu_par" : 9999,       /* phu parameter for determining the variability of phu */
    "basetemp": { "low" : 12.0, "high" :  12.0}, /* min & max basetemp: base temperature */
