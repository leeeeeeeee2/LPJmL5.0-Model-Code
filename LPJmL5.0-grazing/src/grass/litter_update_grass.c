                        ...
                        )
{
  ...
  output->alitfalln_mgrass+=grass->ind.leaf.nitrogen*frac*pft->stand->frac;
  ...
  output->alitfalln_mgrass+=pft->bm_inc.nitrogen*frac*pft->stand->frac;
  ...
  output->alitfalln_mgrass+=grass->ind.root.nitrogen*frac*pft->stand->frac;
