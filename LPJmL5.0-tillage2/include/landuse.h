...
extern Stocks cultivate(Cell *,const Pftpar *,int,Real,Bool,int,Bool,Stand *,
                      Bool,Bool,Real,int,int,int,int,int);
...
extern Stocks sowing_season(Cell *,int,int,int,Real,int,Real,const Config *);
extern Stocks sowing_prescribe(Cell *,int,int,int,int,Real,const Config *);
extern Stocks sowing(Cell *,Real,int,int,int,int,Real,const Config *);
