...
#ifdef FROM_RESTART
  "population" : false,
  "landuse" : CONST_LANDUSE, /* other options: NO_LANDUSE, LANDUSE, CONST_LANDUSE, ALL_CROPS */
  "landuse_year_const" : 2005, /* set landuse year for CONST_LANDUSE case */
  "reservoir" : false,
...
#include "input_rcp26_hadgem.js"    /* Input files of CRU dataset */

/*===================================================================*/
/*  IV. Output data section                                          */
/*===================================================================*/

#define output /p/projects/macmit/users/herzfeld/macmit_tillage_carbon_study/rcp_runs/rcp26_hadgem_bugfix/OUTPUT_NT_R_pix45157
#define restart /p/projects/macmit/users/herzfeld/macmit_tillage_carbon_study/restart
...
-------------------------- ---------------------- ----------------------------- */
    ...
    { "id" : SOILC_AGR_LAYER,  "file" : { "fmt" : RAW, "name" : mkstr(output/soilc_agr_layer.bin)}},
    { "id" : LITC_AGR,         "file" : { "fmt" : RAW, "name" : mkstr(output/litc_agr.bin)}},
    { "id" : ANPP,             "file" : { "fmt" : RAW, "name" : mkstr(output/anpp.bin)}},
    { "id" : ANPP_AGR,         "file" : { "fmt" : RAW, "name" : mkstr(output/anpp_agr.bin)}},
    { "id" : ARH,              "file" : { "fmt" : RAW, "name" : mkstr(output/arh.bin)}},
    { "id" : ARH_AGR,          "file" : { "fmt" : RAW, "name" : mkstr(output/arh_agr.bin)}},
    { "id" : ALITTFALLC_AGR,   "file" : { "fmt" : RAW, "name" : mkstr(output/alittfallc_agr.bin)}},
#ifdef WITH_SPITFIRE
...
/*===================================================================*/
  ...
  "startgrid" : 45157, //ALL, /* 27410, 67208 60400 all grid cells */
  "endgrid" : 45157, //ALL,
  ...
  "write_restart_filename" : mkstr(restart/restart_1900_nv_stdfire_N_pix.lpj), /* filename of restart file */
  "restart_year": 1900 /* write restart at year */

#else

  "nspinup" : 0, //390,   /* spinup years */
  "nspinyear" : 0, //30,  /* cycle length during spinup (yr)*/
  ...
  "restart_filename" : mkstr(restart/restart_2005_crop_stdfire_N_noriver_hadgem_PIX45157.lpj),
//  "restart_filename" : mkstr(restart/restart_2005_crop_stdfire_N_noriver_hadgem_pix.lpj),
//  "restart_filename" : mkstr(restart/restart_1850_nv_stdfire_N.lpj), /* filename of restart file */
  "write_restart" : false, /* create restart file */
  "write_restart_filename" : mkstr(restart/restart_2005_crop_stdfire_N_hadgem_pix.lpj), /* filename of restart file */
