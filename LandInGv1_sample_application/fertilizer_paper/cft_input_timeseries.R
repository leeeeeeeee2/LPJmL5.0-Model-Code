...
manure_weighting_name <- c(
  rainfed = file.path(
    ...
    "hyde_tot_rainfed_annual_1500_2017.nc4"
  ),
  irrigated = file.path(
    "..", "landuse_paper", "HYDE", "NetCDF_full1500-2017",
    "hyde_tot_irri_annual_1500_2017.nc4"
  )
)
...
pasture_weighting_name <- file.path(
  "..", "landuse_paper", "HYDE", "NetCDF_full1500-2017",
  "hyde_grazing_annual_1500_2017.nc4"
)
## Unit of weighting dataset                                                  ##
