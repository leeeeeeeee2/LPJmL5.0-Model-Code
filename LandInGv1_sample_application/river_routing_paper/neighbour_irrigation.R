...
## Grid:                                                                      ##
# 5 minute version
#gridname <- "../gadm_paper/grid_gadm_5arcmin.bin"
# 30 minute version
gridname <- "../gadm_paper/grid_gadm_30arcmin_predefined_grid.bin"
## River routing (such as created by create_river_routing_input.sh):          ##
# 5 minute HydroSHEDS v.1.1
#drainname <- "drainage_hydrosheds_v1.1_5arcmin.bin"
# 5 minute MERIT
#drainname <- "drainage_merit_5arcmin.bin"
# 30 minute DDM30
#drainname <- "drainage_ddm30_30arcmin.bin"
# 30 minute STN
drainname <- "drainage_stn_30arcmin.bin"
...
## automatically).                                                            ##
# Depending on versions above
#version_string <- "hydrosheds_v1.1"
#version_string <- "merit"
#version_string <- "ddm30"
version_string <- "stn"

# Test application for all source datasets above and for all of the following
# settings combinations:
# - search_area <- "adjacent", exclude_upstream <- FALSE,
#   exclude_downstream = FALSE
# - search_area <- "adjacent", exclude_upstream <- TRUE,
#   exclude_downstream = TRUE
# - search_area <- "region", search_radius <- 75000, exclude_upstream <- TRUE,
#   exclude_downstream = TRUE, idw_power_par <- 0
# - search_area <- "region", search_radius <- 75000, exclude_upstream <- TRUE,
#   exclude_downstream = TRUE, idw_power_par <- 2
