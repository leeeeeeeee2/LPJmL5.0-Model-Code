...
## river_routing.R
# 5 minute versions (one of 2)
# HydroSHEDS v.1.1
#upstreamarea_RData <- "../river_routing_paper/drainage_upstreamarea_hydrosheds_v1.1_5arcmin.RData"
# MERIT
#upstreamarea_RData <- "../river_routing_paper/drainage_upstreamarea_merit_5arcmin.RData"

# 30 minute versions (one of 2)
# DDM30
#upstreamarea_RData <- "../river_routing_paper/drainage_upstreamarea_ddm30_30arcmin.RData"
# STN
upstreamarea_RData <- "../river_routing_paper/drainage_upstreamarea_stn_30arcmin.RData"
## Version string (optional)
## Added to names of created files (resolution string added automatically)    ##
# Depending on selected DDM above
