...
## Modified version to generate timeseries of harvested areas in LPJmL format ##
################################################################################
...
scale_down_cfts2cropland <- FALSE
