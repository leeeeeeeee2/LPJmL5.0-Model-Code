...
aquastat_version_string <- "20200417"
fao_version_string <- "20200127"
gadm_version_string <- ""
gaez_version_string <- ""
hyde_version_string <- ""
...
aquastat_file <- "Aquastat/aquastat_irrigated_harvested_areas.csv"
...
aquastat_file_use_FAOSTAT_country_col <- "Country.Code"
...
fao_production_file_includes_livestock <- FALSE
...
gadmborder_file <- "../gadm_paper/ncountry_gadm_5arcmin.nc"
...
ramankutty_base <- file.path("Ramankutty", "CroplandPastureArea2000_Geotiff")
